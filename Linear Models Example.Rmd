...
ht + geom_abline(slope = model$coefficients[2], 
...
#plot
ggplot(p, aes(x = Temperature, y = Pressure))+
  geom_point()
...
#look at residuals 
ggplot(p, aes(x = Temperature, y = resid))+
  geom_point()+
  geom_hline(yintercept = 0)
